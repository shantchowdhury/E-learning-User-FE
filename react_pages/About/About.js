    ...
    <div className="relative">
      ...
      <section className="site-container lg:px-[80px] lg:py-0 py-10 min-h-[50vh] flex lg:flex-row flex-col items-center">
        <div className="lg:text-left text-center">
          ...
          <Link to="/contact" className="w-32 h-[40px] p-[2px] rounded-full lg:block hidden bg-gradient-to-r from-pink to-cyan mt-5 text-sm md:text-sm font-Poppins dfont-[300]">
