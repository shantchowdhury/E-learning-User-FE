...
import { forgotPassword } from '@/redux/securityservice/securityActions';
    ...
    <div className={styles.main}>
      <div className='relative'>
        ...
        <form onSubmit={Sendlink} className={styles.flex}>
          ...
          <Link href='/signin' className='text-center flex items-center gap-2 text-[15px] font-Averta text-sky-500'>
