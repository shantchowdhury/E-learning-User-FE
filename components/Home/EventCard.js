  ...
  return (
    <div className="w-[95%] md:w-[45%] lg:w-[30%] xl:w-[25%]">
      <div className="w-full rounded-xl overflow-hidden cursor-pointer transition hover:drop-shadow-md">
        <img
          className="w-full"
          src="/assets/images/homeevent.png"
          alt="Mountain"
        />
        <div className="px-6 py-6 bg-black border border-white/10 border-t-0 space-y-2 rounded-b-xl">
          <div className="font-semibold mb-2">
            <h1 className="text-[18px] sm:text-xl">How to enhance your career</h1>
          </div>
